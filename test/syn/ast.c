...
static void new_drop() {
    an_expr and;
    {
        ...
        and = an_expr_new_and(BOX(&lhs), BOX(&rhs));
    }
    ...
    an_expr mul;
    {
        ...
        mul = an_expr_new_mul(BOX(&lhs), BOX(&rhs));
    }
    ...
    an_expr add;
    {
        ...
        add = an_expr_new_add(BOX(&lhs), BOX(&rhs));
    }

    an_expr eq = an_expr_new_eq(BOX(&mul), BOX(&add));
    eq = an_expr_new_ne(BOX(&eq), BOX(&and));
